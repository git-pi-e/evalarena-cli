...
CREATOR_COLORS = {
    ...
    "LG Research": "red",
    "MistralAI": "yellow",
    "Amazon": "bright_yellow",
    "Tencent Hunyuan": "cyan",
    "Bytedance": "bright_cyan",
    "Moonshot AI": "bright_blue",
    "OpenGVLab": "blue",
    "Xiaomi": "bright_red",
    "MiniMax": "bright_magenta",
    "Baidu": "blue",
    "ZhipuAI": "bright_magenta",
    "Huawei": "red",
}
...
def generate_horizontal_bar_chart(models, values, metric, normalize):
    ...
    max_name_length = min(40, max(len(clean_model_name(m.name)) for m in models))
    max_bar_length = 50
    ...
    for i, (model, value) in enumerate(zip(models, values)):
        ...
        bar = BAR_PATTERN * max(1, bar_length)
